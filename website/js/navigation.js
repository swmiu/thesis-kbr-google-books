    ...
    const pages = {
        ...
        'language_distribution': `
            ...
            <div class="chart-description">
                ...
                <p>Beyond these four, the sample spans a further six "foreign" languages across multiple language families: English (5.3%), Italian (4.3%), Spanish (1.8%), Portuguese (0.5%), Russian (0.4%), and Swedish (0.1%), pointing to the breadth of KBR's acquisition scope beyond the French-speaking world. One thing to note is a small number of records (1.3%) carrying more than one language code and are grouped as "multiple languages" following the <em>Europeana</em> convention. The interactive legend allows readers to hover on individual languages for details.</p>
            </div>
        `,
