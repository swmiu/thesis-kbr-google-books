...
function loadPage(pageName) {
    ...
    const pages = {
        ...
        'introduction': `
            ...
            <div class="chart-description">
                <p>In Belgium, copyright law provides protection for up to 70 years after the death of the author, while Google Books opted for 125 years for copyright protection. With 2026 as the project's closing year, this timeline places the upper boundary of the eligible collection at 1901. The lower boundary of 1602 comes from the earliest publication year present in this sample, reflecting the natural historical depth of KBR's holdings. Together, these dates frame a 300-year window of European publication history and define the temporal scope of every visualisation on this site.</p>
            </div>
        `,
